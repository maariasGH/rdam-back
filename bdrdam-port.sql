...
\restrict RmWi3HNJW3oqVrMBoKLQpco8NrjwXKWbTIu8JKnifDnaIO2oX1hKSZQrcNWBLaP

-- Dumped from database version 18.2
-- Dumped by pg_dump version 18.2

-- Started on 2026-03-03 21:25:58
...
COPY public.certificados (certificado_id, tramite_id, fecha_emision, url_archivo_s3, usuario_id) FROM stdin;
1	3	2026-03-03 19:02:11.689331	aa	3
\.


--
-- TOC entry 5065 (class 0 OID 16450)
-- Dependencies: 224
...
--
-- TOC entry 5063 (class 0 OID 16430)
-- Dependencies: 222
...
4	111111111111	axel	axel@example.com	EMITIDA	2026-03-03	1	2026-03-03 18:56:01.761545	Arabia
3	20461340602	Mariano Arias	marian@example.com	PAGADA	2026-03-03	1	2026-03-03 19:02:11.689331	Santa Fe
\.


--
-- TOC entry 5061 (class 0 OID 16412)
-- Dependencies: 220
...
1	Admin Sistema	admin	pbkdf2:sha256:250000$xxxx	ADMINISTRADOR	Activo	2026-02-25 17:41:37.504766	1
2	Mariano Arias	mariano	pbkdf2:sha256:250000$yyyy	CIUDADANO	Activo	2026-02-25 17:41:37.508524	1
3	Carlos	car	123	OPERADOR	Activo	2026-03-03 18:35:36.702615	\N
4	Ciudadano	ciudadano	null	CIUDADANO	Activo	2026-03-03 18:37:38.822296	\N
\.
...
SELECT pg_catalog.setval('public.certificados_certificado_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.tramites_tramite_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.usuarios_usuario_id_seq', 5, true);
...
-- Name: certificados fk_certificado_usuario; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.certificados
    ADD CONSTRAINT fk_certificado_usuario FOREIGN KEY (usuario_id) REFERENCES public.usuarios(usuario_id);
...
-- Completed on 2026-03-03 21:25:58

--
-- PostgreSQL database dump complete
--

\unrestrict RmWi3HNJW3oqVrMBoKLQpco8NrjwXKWbTIu8JKnifDnaIO2oX1hKSZQrcNWBLaP
